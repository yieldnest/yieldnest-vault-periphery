...
contract HooksMock is IHooks {
    ...
    // Fill in the rest of the IHooks interface, including all fee-related functions, even if unused
    function baseManagementFee() external pure returns (uint256) {
        return 0;
    }

    function setBaseManagementFee(uint256) external {}

    function baseManagementFeeRecipient() external pure returns (address) {
        return address(0);
    }

    function setBaseManagementFeeRecipient(address) external {}
    ...
    function withdrawalFeeRecipient() external pure returns (address) {
        return address(0);
    }

    function setWithdrawalFeeRecipient(address) external {}
    ...
    function depositFeeRecipient() external pure returns (address) {
        return address(0);
    }

    function setDepositFeeRecipient(address) external {}
    ...
    function mintFeeRecipient() external pure returns (address) {
        return address(0);
    }

    function setMintFeeRecipient(address) external {}

    function redeemFee() external pure returns (uint256) {
        return 0;
    }

    function setRedeemFee(uint256) external {}

    function redeemFeeRecipient() external pure returns (address) {
        return address(0);
    }

    function setRedeemFeeRecipient(address) external {}
